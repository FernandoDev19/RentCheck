...
import { VEHICLE_GAMMAS } from "../constants/vehicle-gammas";
...
export default function VehicleForm({
    ...
    return (
        <div className="text-left text-xs transition-all ease-linear duration-500">
            <div
                style={{
                    display: "grid",
            ...
            >
                <div>
                    ...
                    <Input
                        ...
                        list="vehicle-gammas"
                    />
                    <datalist id="vehicle-gammas">
                        {VEHICLE_GAMMAS.map((g) => (
          ...
          {errors?.insuredValue && (
            <p className="text-red-500 text-sm">{errors.insuredValue}</p>
                ...
                <div>
                    <Label htmlFor="v-rentalPriceByDay">
                    ...
                    <Input
                        ...
                        onChange={(element) =>
                            handleInputCurrency(
                                Number(element.target.value).toLocaleString(
                                    "es-CO",
                                ),
                            )
                        }
                        value={
                            currentValues?.rentalPriceByDay ||
                            vehicle?.rentalPriceByDay ||
                            Number(currency)?.toLocaleString("es-CO")
                        }
                        className={
